...
bool LinearAllocator_create_with_allocator(LinearAllocator* self, const char* name, struct FldAllocator* allocator,
...
FLD_INLINE void LinearAllocator_rewind(LinearAllocator* self) {
...
FLD_INLINE int LinearAllocator_memory_left(LinearAllocator* alloc) {
...
FLD_INLINE int LinearAllocator_current_position(LinearAllocator* alloc) {
